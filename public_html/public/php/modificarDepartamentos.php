...
require_once("modificarDepartamentosFunciones.php");
...
$idDepartamento = intval($data->idDepartamento);
...
modificarDepartamento($conn, $idDepartamento, $nombreDepartamento, $jefeDepartamento, $correoJefatura, $correoProyecto);