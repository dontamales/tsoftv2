...
require_once("modificarTiposTitulacionFunciones.php");
...
$idTipoTitulacion = intval($data->idTipoTitulacion);
...
modificarTipoTitulacion($conn, $idTipoTitulacion, $nombreTipoTitulacion, $documentos, $planEstudio);