        ...
        <div class="col-12">
          <div class="text-center">
            ...
            if ($estatusUsuarioID == 1) {
              ...
              // Mensaje personalizado con correo del departamento académico
            ...
            <?php if ($estatusUsuarioID >= 5): ?>
              <div class="mt-5">
                <h3 class="text-center">Estado de tus documentos</h3>
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped" id="tablaDocumentosEgresado">
